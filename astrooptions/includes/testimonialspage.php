...
<div class="row">
  ...
  <source src="images/video1.mp4" type="video/ogg">
</video>
        </div>
        <div class="col-md-4 col-sm-4 "><!--
...
<video width="320" height="240" controls>
  ...
  <source src="images/video3.mp4" type="video/ogg">
</video>        </div>
      </div>
    </div>
  </div></p>
...
<video width="320" height="240" controls>
  ...
  <source src="images/video4.mp4" type="video/ogg">
</video>        </div>
        <div class="col-md-4 col-sm-4 "><!--
          <div class="home-features-item time">
            <svg viewBox="0 0 58.58 50.99">
...
<video width="320" height="240" controls>
  ...
  <source src="images/video5.mp4" type="video/ogg">
</video>        </div>
        <div class="col-md-4 col-sm-4 "><!--
          <div class="home-features-item investment">
            <svg viewBox="0 0 49.05 57.09">
...
<video width="320" height="240" controls>
  ...
  <source src="images/video6.mp4" type="video/ogg">
</video>        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
          ...
          <div class="col-md-4 col-sm-4 col-xs-4">
            <div class="plan-item plan1">
              <div class="plan-body">
                <div class="plan-profit"> <strong>10<b>%</b></strong> <span> <br>In 3 days</span></div>
                <div class="plan-bg"></div>
                <div class="plan-bottom"> <span>Minimum Deposit:</span> <strong>$100<b></b></strong> <span>Maximum Deposit:</span> <strong>$5,000</strong>
                <div class=""> 
          ...
          <div class="col-md-4 col-sm-4 col-xs-4">
            <div class="plan-item plan2">
              <div class="plan-body">
                <div class="plan-profit"> <strong>30<b>%</b></strong> <span><br>In 5 Days</span></div>
                <div class="plan-bg"></div>
